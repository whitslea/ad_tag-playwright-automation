...
const { kargoLink, bottomBannerAdLink, bottomBannerDemoAdLink } = require('../Ads Info/Ads Links');

test.describe('Sandbox Bottom Banner Ad Page', () => {
  test('Check and Click on Kargo Logo', async ({ context }) => {
    const page = await context.newPage();
    // Start waiting for new page before clicking
    const pagePromise = context.waitForEvent('page');
    // Go to the starting url
    await page.goto(bottomBannerDemoAdLink);
    await expect(page).toHaveURL(bottomBannerDemoAdLink);
